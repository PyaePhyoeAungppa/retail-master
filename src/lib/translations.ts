...
export const translations: Record<Language, Translation> = {
  ...
  mm: {
    ...
    showcase: {
      ...
      social_description: "ကျွမ်းကျင်ဆန်သော အော်ဒါမှတ်တမ်းများကို Linkများမှတစ်ဆင့် ပေးပို့နိုင်ပါသည်။ WhatsApp, Messenger နှင့် Viber တို့တွင် ငွေပေးချေရန် အချက်အလက်များနှင့်အတူ ချက်ချင်း မျှဝေနိုင်ပါသည်။",

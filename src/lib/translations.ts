...
export const translations: Record<Language, Translation> = {
  ...
  mm: {
    ...
    showcase: {
      inventory_badge: "တိကျသော stock မှတ်တမ်း",
      inventory_title: "stock များကို စနစ်တကျ ထိန်းသိမ်းပါ။",
      inventory_subtitle: "ပစ္စည်းပြတ်လို့ အရောင်းလွတ်တာမျိုး မရှိစေရ။",
      inventory_description: "ပစ္စည်းပြတ်တော့မည့်အချိန်တွင် အချက်ပေးသည့်အပြင် ပစ္စည်းတစ်ခုချင်းစီအလိုက် stock မှတ်စရာလို/မလိုကိုလည်း စိတ်ကြိုက်ရွေးချယ်နိုင်သောကြောင့် stock စီမံရတာ ပိုမိုလွယ်ကူလာပါမည်။",
      inventory_points: ["ပစ္စည်းပြတ်ရန်နီးကပ်ပါက အလိုအလျောက် အကြောင်းကြားပေးခြင်း", "ပစ္စည်းအလိုက် stock မှတ်စရာလို/မလို ရွေးချယ်နိုင်ခြင်း", "ပစ္စည်းအများအပြားကို တစ်ခါတည်း စီမံနိုင်ခြင်း", "ဆိုင်ခွဲများအကြား stock အချက်အလက် ချိတ်ဆက်နိုင်ခြင်း"],
      social_badge: "ဒစ်ဂျစ်တယ် POS စနစ်",
      social_title: "Chat ထဲမှာတင် အရောင်းပိတ်လိုက်ပါ။",
      social_subtitle: "အော်ဒါလင့်ခ်များ ချက်ချင်းပေးပို့ရန်။",
      social_description: "Professional ဆန်သော အော်ဒါမှတ်တမ်းများကို Link များမှတစ်ဆင့် ပေးပို့နိုင်ပါသည်။ WhatsApp, Messenger နှင့် Viber တို့တွင် ငွေပေးချေရန် အချက်အလက်များနှင့်အတူ ချက်ချင်း မျှဝေနိုင်ပါသည်။",
      ...
      reports_points: ["ဆိုင်ပိုင်ရှင်: လုပ်ငန်းတစ်ခုလုံးကို အနှစ်ချုပ် ကြည့်ရှုနိုင်ခြင်း", "မန်နေဂျာ: stock နှင့် အဆိုင်းများ စီမံနိုင်ခြင်း", "အရောင်းဝန်ထမ်း: အရောင်းနှင့် ဝယ်သူများကို စီမံနိုင်ခြင်း", "ဝယ်သူတစ်ဦးချင်းစီ၏ ဝယ်ယူမှုမှတ်တမ်းများ"],
    },
    audience: {
      ...
      items: [
        ...
        { title: "အွန်လိုင်းဆိုင်များ", desc: "Tablet/Laptop ဖြင့် လုပ်ငန်းတစ်ခုလုံးကို လွယ်ကူစွာ စီမံနိုင်သည်။" },
    ...
    cta: {
      ...
      trial_info: "၁ လ အခမဲ့ အသုံးပြုနိုင်သည် · Credit Card မလိုပါ · နည်းပညာအကူအညီ ပါဝင်သည်",
    },
    how_it_works: {
      badge: "အသုံးပြုပုံ အဆင့်ဆင့်",
      title: "မိနစ်ပိုင်းအတွင်း",
      subtitle: "စတင်အသုံးပြုနိုင်ပါသည်။",
      description: "ကျွန်ုပ်တို့၏ ပလက်ဖောင်းကို အမြန်ဆုံး အသုံးပြုနိုင်ရန် ဒီဇိုင်းထုတ်ထားပါသည်။ ခက်ခဲသော Installation များ မလိုအပ်ဘဲ Tablet/Laptop ရှိရုံဖြင့် စတင်အသုံးပြုနိုင်ပါသည်။",
      steps: [
        ...
        { title: "ပစ္စည်းများထည့်သွင်းခြင်း", desc: "သင့်ပစ္စည်းများကို ဈေးနှုန်း၊ stock များနှင့်အတူ ထည့်သွင်းပါ။ stock မှတ်စရာလို/မလို ရွေးချယ်နိုင်ပါသည်။" },
      ...
      preview_desc: "Online Shopping များအတွက် အထူးရည်ရွယ်ပါသည်။ အော်ဒါများကို လွယ်ကူစွာ ကိုင်တွယ်နိုင်ပြီး ဘေလ်လင့်ခ်များကို ချက်ချင်း ပေးပို့နိုင်ပါသည်။",
    },
  },
};

...
export const translations: Record<Language, Translation> = {
  ...
  mm: {
    ...
    showcase: {
      ...
      inventory_description: "ပစ္စည်းပြတ်တော့မည့်အချိန်တွင် အချက်ပေးပေးသည့်အပြင် ပစ္စည်းတစ်ခုချင်းစီအလိုက် stock မှတ်စရာလို/မလိုကိုလည်း စိတ်ကြိုက်ရွေးချယ်နိုင်သောကြောင့် stock စီမံရတာ ပိုမိုလွယ်ကူလာပါမည်။",
